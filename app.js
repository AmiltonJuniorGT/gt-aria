/* ================================
   ...
   ✅ Dentro do vendedor: ordenação hierárquica por camadas
      1) DATA_CADASTRO (por DIA) desc
      2) TOTAL_AGENDAMENTOS asc
      3) MIDIA por CONVERSÃO desc
      4) CURSO por CONVERSÃO desc
   ✅ Drag muda a ordem dessas chaves (dentro do vendedor)
=================================== */
...
/**
 * Agora as chaves arrastáveis representam exatamente as “camadas” da hierarquia.
 * (VENDEDOR é fixo e não entra no drag)
 */
const DEFAULT_PRIORIDADE = ["DATA_CADASTRO", "TOTAL_AGENDAMENTOS", "MIDIA", "CURSO"];

/** direção por campo (fixa) */
const SORT_DIR = {
  DATA_CADASTRO: "desc",        // mais atual primeiro
  TOTAL_AGENDAMENTOS: "asc",    // menor primeiro
  MIDIA: "desc",                // maior conversão primeiro
  CURSO: "desc",                // maior conversão primeiro
};
